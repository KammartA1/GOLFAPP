...
==========================================
Validates data completeness across the golf system.
...
class CompletenessAuditor:
    ...
    def _check_bet_completeness(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if total == 0:
                return {
                    "completeness_pct": 100.0, "total_bets": 0,
                    "settled_bets": 0, "complete_bets": 0,
                    "missing_opening_pct": 0.0, "missing_closing_pct": 0.0,
                    "missing_snapshot_pct": 0.0, "missing_clv_pct": 0.0,
    ...
    def _check_event_coverage(self) -> Dict[str, Any]:
        """Check what % of events/tournaments have line movement data."""
        session = self._session()
        try:
            issues = []
            ...
            if not all_events:
                ...
                if bet_count > 0 and movement_count == 0:
                    ...
                    return {
                        "coverage_pct": 0.0, "with_lines": 0,
                        "without_lines": bet_count, "issues": issues,
                    }
                return {"coverage_pct": 100.0, "with_lines": 0,
                        "without_lines": 0, "issues": []}
            ...
            if without_lines > 0:
                issues.append(
                    f"EVENTS_WITHOUT_LINES: {without_lines}/{len(all_events)} "
                    f"tournaments have no line movement history"
                )
    ...
    def _check_systematic_gaps(self) -> Dict[str, Any]:
        ...
        try:
            ...
            book_coverage: Dict[str, int] = {book: count for book, count in book_counts}
            ...
            market_coverage: Dict[str, int] = {market: count for market, count in market_counts}
