...
class UIBridge:
    ...
    def _get_exposure(self) -> dict:
        ...
        try:
            ...
            return {"total_wagered": 0, "by_confidence": {}}
        ...
        try:
            with _session() as session:
                latest_date = (
                    ...
                    .filter(CalibrationSnapshot.sport == "GOLF")
                    .scalar()
                )
                if not latest_date:
                    return []
                ...
                rows = (
                    ...
                    .filter(
                        CalibrationSnapshot.sport == "GOLF",
    ...
    @_safe({
        ...
        "worker_statuses": [],
        "todays_signals": [],
        "exposure": {"total_wagered": 0, "by_confidence": {}},
    ...
    def get_command_center_data(self) -> dict:
        ...
        Keys:
            ...
            todays_signals (list of dicts with player, event, market, edge_pct,
                            rec_stake, action),
            exposure (dict with total_wagered, by_confidence),
    ...
    def get_signals_data(
        ...
        """
        with _session() as session:
            q = session.query(Signal).filter(Signal.sport == "GOLF")
        ...
        for r in rows:
            ...
            results.append({
                ...
                "model_prob": 0.0,  # Signal table doesn't store raw prob; placeholder
                "market_prob": 0.0,
                "edge_pct": r.edge_pct or 0.0,
                "clv_expected": 0.0,  # Computed downstream if needed
    ...
    def get_system_health(self) -> dict:
        ...
        try:
            ...
            db_health = {"status": "error", "error": "Could not reach database"}
