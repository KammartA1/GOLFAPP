...
================================
CLV System dashboard for Golf — the TRUTH ENGINE.
    ...
    with col1:
        ...
        if latest:
            ...
            border-radius: 12px; margin: 10px 0;'>
                ...
                font-family: Inter, sans-serif;'>{score:.0f}/100</div>
...
def _render_line_movements():
    ...
    with col1:
        player = st.text_input("Player Name", placeholder="e.g. Scottie Scheffler")
    with col2:
        market = st.text_input("Market Type", placeholder="e.g. Birdies")
    with col3:
...
def _render_empty_state():
    ...
    border-radius: 12px; margin: 20px 0;'>
        <div style='font-size: 1.2rem; color: #6B7B8D; font-family: Inter, sans-serif;
        margin-bottom: 10px;'>CLV SYSTEM INITIALIZING</div>
        <div style='font-size: 0.75rem; color: #4A607A; font-family: JetBrains Mono, monospace;'>
            The CLV system needs at least 10 settled bets with closing lines to produce metrics.<br><br>
            <b>How it works:</b><br>
            1. Odds are captured every 15 minutes from PrizePicks + The Odds API<br>
            2. When a bet signal fires, a market snapshot is taken<br>
            3. At first tee time, closing lines are captured automatically<br>
